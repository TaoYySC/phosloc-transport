...
class AlphaMissensePreprocessor(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None):
        ...
        cols = [c for c in X.columns if c.startswith("FUNC_AlphaMissense_")]
        ...
        if "FUNC_AlphaMissense_HasAnyVariant" in X_num.columns:
            X_num["FUNC_AlphaMissense_HasAnyVariant"] = (
                X_num["FUNC_AlphaMissense_HasAnyVariant"]
                .replace({True: 1.0, False: 0.0, "True": 1.0, "False": 0.0})
            )
